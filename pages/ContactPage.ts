...
export class ContactPage {
  ...
  constructor(page: Page) {
    ...
    this.phoneInput = page
      .locator('input[name="phone"], input[placeholder="Phone"]')
      .or(page.locator('label:has-text("Phone") + input'))
      .first();
    this.subjectInput = page
      .locator('input[name="subject"], input[placeholder="Subject"]')
      .or(page.locator('label:has-text("Subject") + input'))
      .first();
    this.messageTextarea = page
      .locator('textarea[name="message"], textarea[placeholder*="message" i]')
      .or(page.locator('label:has-text("Message") + textarea'))
      .first();
    this.submitButton = page.getByRole("button", { name: "Submit" });
    this.successMessage = page
      .locator("text=/thank|success|sent|received/i")
      .first();
